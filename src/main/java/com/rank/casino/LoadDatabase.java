...
class LoadDatabase {
    ...
    CommandLineRunner initDatabase(PlayerRepository repository, TransactionRepository transactionRepository) {
        ...
        return args -> {
            log.info("Preloading " + repository.save(new Player(0.00)));
            log.info("Preloading " + repository.save(new Player(100.0)));
            log.info("Preloading " + repository.save(new Player(10.0)));
            log.info("Preloading " + repository.save(new Player(800.0)));
            log.info("Preloading " + repository.save(new Player(99.0)));
            log.info("Preloading " + repository.save(new Player(1000.0)));
            log.info("Preloading " + repository.save(new Player(88.0)));
